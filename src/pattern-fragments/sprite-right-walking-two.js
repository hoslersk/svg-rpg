...
export default function SpriteRightWalkingTwo() {
  return (
    <>
      ...
      <path fill="#7f4040" d="M9 13h1v1H9zm1 0h1v1h-1z"/>
      <path d="M2 14h1v1H2z"/>
      ...
      <path fill="#10203f" d="M8 14h1v1H8z"/>
      <path fill="#c04040" d="M9 14h1v1H9z"/>
      <path fill="#7f4040" d="M10 14h1v1h-1zm1 0h1v1h-1z"/>
      <path d="M2 15h1v1H2z"/>
      <path fill="#bf985f" d="M3 15h1v1H3zm1 0h1v1H4z"/>
      <path d="M5 15h1v1H5z"/>
      <path fill="#ffc05f" d="M6 15h1v1H6zm1 0h1v1H7z"/>
      <path d="M8 15h1v1H8z"/>
      <path fill="#10203f" d="M9 15h1v1H9z"/>
      <path fill="#c04040" d="M10 15h1v1h-1z"/>
      ...
      <path d="M8 16h1v1H8z"/>
      <path fill="#10203f" d="M9 16h1v1H9zm1 0h1v1h-1z"/>
      <path fill="#7f4040" d="M11 16h1v1h-1z"/>
      <path d="M12 16h1v1h-1zM2 17h1v1H2z"/>
      <path fill="#7f4040" d="M3 17h1v1H3z"/>
      <path d="M4 17h1v1H4zm1 0h1v1H5zm1 0h1v1H6zm1 0h1v1H7zm1 0h1v1H8z"/>
      <path fill="#10203f" d="M9 17h1v1H9zm1 0h1v1h-1z"/>
      <path d="M11 17h1v1h-1z"/>
      <path fill="#ff605f" d="M12 17h1v1h-1z"/>
      <path d="M13 17h1v1h-1zM2 18h1v1H2z"/>
      <path fill="#7f4040" d="M3 18h1v1H3zm1 0h1v1H4z"/>
      <path d="M5 18h1v1H5zm1 0h1v1H6zm1 0h1v1H7zm1 0h1v1H8zm1 0h1v1H9zm1 0h1v1h-1z"/>
      <path fill="#bf985f" d="M11 18h1v1h-1z"/>
      <path fill="#ff605f" d="M12 18h1v1h-1z"/>
      <path d="M13 18h1v1h-1zM3 19h1v1H3zm1 0h1v1H4zm5 0h1v1H9z"/>
      <path fill="#7f4040" d="M10 19h1v1h-1zm1 0h1v1h-1z"/>
      <path d="M12 19h1v1h-1zm-2 1h1v1h-1zm1 0h1v1h-1z"/>
    </>
  );
}
