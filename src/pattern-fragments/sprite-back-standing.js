...
export default function SpriteBackStanding() {
  return (
    <>
      ...
      <path fill="#c04040" d="M4 12h1v1H4z"/>
      ...
      <path fill="#ffc05f" d="M1 14h1v1H1z"/>
      <path fill="#7f4040" d="M2 14h1v1H2z"/>
      <path d="M3 14h1v1H3zm1 0h1v1H4z"/>
      <path fill="#bf985f" d="M5 14h1v1H5z"/>
      <path fill="#fff8ff" d="M6 14h1v1H6zm1 0h1v1H7z"/>
      <path fill="#bf985f" d="M8 14h1v1H8z"/>
      <path d="M9 14h1v1H9zm1 0h1v1h-1z"/>
      <path fill="#7f4040" d="M11 14h1v1h-1z"/>
      <path fill="#ffc05f" d="M12 14h1v1h-1z"/>
      ...
      <path fill="#7f4040" d="M3 19h1v1H3zm1 0h1v1H4zm1 0h1v1H5z"/>
      <path d="M6 19h1v1H6zm1 0h1v1H7z"/>
      <path fill="#7f4040" d="M8 19h1v1H8zm1 0h1v1H9zm1 0h1v1h-1z"/>
