...
export default function SpriteFrontStanding(props) {
  return (
    <>
      <path fill="#3f487f" d="M9 0h1v1H9zM8 1h1v1H8z"/>
      <path fill="#fff8ff" d="M9 1h1v1H9z"/>
      <path fill="#3f487f" d="M10 1h1v1h-1zM4 2h1v1H4zm1 0h1v1H5zm1 0h1v1H6zm1 0h1v1H7z"/>
      ...
      <path d="M2 12h1v1H2zm1 0h1v1H3z"/>
      ...
      <path d="M10 12h1v1h-1zm1 0h1v1h-1zM1 13h1v1H1z"/>
      <path fill="#c04040" d="M2 13h1v1H2z"/>
      <path fill="#10203f" d="M3 13h1v1H3zm1 0h1v1H4z"/>
      <path d="M5 13h1v1H5zm1 0h1v1H6zm1 0h1v1H7zm1 0h1v1H8z"/>
      <path fill="#10203f" d="M9 13h1v1H9zm1 0h1v1h-1z"/>
      <path fill="#c04040" d="M11 13h1v1h-1z"/>
      <path d="M12 13h1v1h-1z"/>
      <path fill="#7f4040" d="M0 14h1v1H0z"/>
      <path fill="#ffc05f" d="M1 14h1v1H1zm1 0h1v1H2z"/>
      <path d="M3 14h1v1H3z"/>
      <path fill="#10203f" d="M4 14h1v1H4zm1 0h1v1H5z"/>
      <path fill="#c04040" d="M6 14h1v1H6zm1 0h1v1H7z"/>
      <path fill="#10203f" d="M8 14h1v1H8zm1 0h1v1H9z"/>
      <path d="M10 14h1v1h-1z"/>
      <path fill="#ffc05f" d="M11 14h1v1h-1zm1 0h1v1h-1z"/>
      <path fill="#7f4040" d="M13 14h1v1h-1zM0 15h1v1H0z"/>
      <path fill="#bf985f" d="M1 15h1v1H1zm1 0h1v1H2z"/>
      <path fill="#7f4040" d="M3 15h1v1H3z"/>
      <path fill="#c04040" d="M4 15h1v1H4z"/>
      <path fill="#10203f" d="M5 15h1v1H5zm1 0h1v1H6zm1 0h1v1H7zm1 0h1v1H8z"/>
      <path fill="#c04040" d="M9 15h1v1H9z"/>
      <path fill="#7f4040" d="M10 15h1v1h-1z"/>
      <path fill="#bf985f" d="M11 15h1v1h-1zm1 0h1v1h-1z"/>
      <path fill="#10203f" d="M13 15h1v1h-1z"/>
      <path d="M1 16h1v1H1zm1 0h1v1H2zm1 0h1v1H3z"/>
      <path fill="#7f4040" d="M4 16h1v1H4z"/>
      <path fill="#c04040" d="M5 16h1v1H5z"/>
      <path fill="#10203f" d="M6 16h1v1H6zm1 0h1v1H7z"/>
      <path fill="#c04040" d="M8 16h1v1H8z"/>
      <path fill="#7f4040" d="M9 16h1v1H9z"/>
      <path d="M10 16h1v1h-1zm1 0h1v1h-1z"/>
      <path fill="#10203f" d="M12 16h1v1h-1z"/>
      <path d="M2 17h1v1H2zm1 0h1v1H3zm1 0h1v1H4z"/>
      <path fill="#7f4040" d="M5 17h1v1H5zm1 0h1v1H6zm1 0h1v1H7zm1 0h1v1H8z"/>
      <path d="M9 17h1v1H9zm1 0h1v1h-1zm1 0h1v1h-1zm-9 1h1v1H2z"/>
      <path fill="#7f4040" d="M3 18h1v1H3z"/>
      <path d="M4 18h1v1H4zm1 0h1v1H5zm1 0h1v1H6zm1 0h1v1H7zm1 0h1v1H8zm1 0h1v1H9z"/>
      <path fill="#7f4040" d="M10 18h1v1h-1z"/>
      <path d="M11 18h1v1h-1zm-9 1h1v1H2z"/>
      <path fill="#c04040" d="M3 19h1v1H3z"/>
      <path fill="#7f4040" d="M4 19h1v1H4z"/>
      <path fill="#c04040" d="M5 19h1v1H5z"/>
      <path d="M6 19h1v1H6zm1 0h1v1H7z"/>
      <path fill="#c04040" d="M8 19h1v1H8z"/>
      <path fill="#7f4040" d="M9 19h1v1H9z"/>
      <path fill="#c04040" d="M10 19h1v1h-1z"/>
      <path d="M11 19h1v1h-1zm-8 1h1v1H3zm1 0h1v1H4zm1 0h1v1H5zm3 0h1v1H8zm1 0h1v1H9zm1 0h1v1h-1z"/>
    </>
  );
}
