...
export default function SpriteLeftStanding() {
  return (
    <>
      ...
      <path fill="#3f487f" d="M10 3h1v1h-1zm1 0h1v1h-1zM0 4h1v1H0zm1 0h1v1H1z"/>
      ...
      <path fill="#10203f" d="M5 13h1v1H5z"/>
      <path fill="#c04040" d="M6 13h1v1H6z"/>
      <path fill="#10203f" d="M7 13h1v1H7z"/>
      <path fill="#bf985f" d="M8 13h1v1H8zm1 0h1v1H9z"/>
      <path d="M10 13h1v1h-1z"/>
      <path fill="#7f4040" d="M2 14h1v1H2z"/>
      <path fill="#c04040" d="M3 14h1v1H3z"/>
      <path fill="#10203f" d="M4 14h1v1H4z"/>
      <path d="M5 14h1v1H5zm1 0h1v1H6z"/>
      <path fill="#10203f" d="M7 14h1v1H7z"/>
      ...
      <path fill="#10203f" d="M3 15h1v1H3z"/>
      <path d="M4 15h1v1H4z"/>
      <path fill="#ffc05f" d="M5 15h1v1H5zm1 0h1v1H6z"/>
      <path d="M7 15h1v1H7z"/>
      <path fill="#10203f" d="M8 15h1v1H8z"/>
      <path fill="#bf985f" d="M9 15h1v1H9zm1 0h1v1h-1z"/>
      <path d="M11 15h1v1h-1zm-9 1h1v1H2z"/>
      <path fill="#10203f" d="M3 16h1v1H3z"/>
      <path d="M4 16h1v1H4z"/>
      <path fill="#bf985f" d="M5 16h1v1H5zm1 0h1v1H6z"/>
      <path d="M7 16h1v1H7zm1 0h1v1H8z"/>
      <path fill="#bf985f" d="M9 16h1v1H9z"/>
      <path d="M10 16h1v1h-1zm-7 1h1v1H3zm1 0h1v1H4zm1 0h1v1H5zm1 0h1v1H6zm1 0h1v1H7zm1 0h1v1H8zm1 0h1v1H9zm-6 1h1v1H3zm1 0h1v1H4zm1 0h1v1H5zm1 0h1v1H6zm1 0h1v1H7zm1 0h1v1H8zm-6 1h1v1H2z"/>
      <path fill="#c04040" d="M3 19h1v1H3z"/>
      <path fill="#10203f" d="M4 19h1v1H4zm1 0h1v1H5z"/>
      <path fill="#bf985f" d="M6 19h1v1H6z"/>
      <path fill="#7f4040" d="M7 19h1v1H7z"/>
      <path d="M8 19h1v1H8zm-5 1h1v1H3zm1 0h1v1H4zm1 0h1v1H5zm1 0h1v1H6zm1 0h1v1H7z"/>
      <rect fill="#3f487f" x="13" y="5" width="1" height="1" />
    </>
  );
}
