...
export default function SpriteLeftWalkingOne() {
  return (
    <>
      ...
      <path d="M5 8h1v1H5z"/>
      <path fill="#10203f" d="M6 8h1v1H6zm1 0h1v1H7zm1 0h1v1H8zm1 0h1v1H9zm1 0h1v1h-1z"/>
      ...
      <path fill="#10203f" d="M3 14h1v1H3z"/>
      <path d="M4 14h1v1H4zm1 0h1v1H5z"/>
      ...
      <path d="M11 14h1v1h-1zM1 15h1v1H1z"/>
      <path fill="#7f4040" d="M2 15h1v1H2z"/>
      <path d="M3 15h1v1H3z"/>
      <path fill="#ffc05f" d="M4 15h1v1H4zm1 0h1v1H5z"/>
      <path d="M6 15h1v1H6z"/>
      <path fill="#10203f" d="M7 15h1v1H7zm1 0h1v1H8z"/>
      <path fill="#bf985f" d="M9 15h1v1H9zm1 0h1v1h-1z"/>
      <path d="M11 15h1v1h-1zM0 16h1v1H0z"/>
      <path fill="#7f4040" d="M1 16h1v1H1z"/>
      <path d="M2 16h1v1H2zm1 0h1v1H3z"/>
      <path fill="#bf985f" d="M4 16h1v1H4zm1 0h1v1H5z"/>
      <path d="M6 16h1v1H6zm1 0h1v1H7zm1 0h1v1H8z"/>
      <path fill="#bf985f" d="M9 16h1v1H9z"/>
      <path d="M10 16h1v1h-1zM0 17h1v1H0z"/>
      <path fill="#7f4040" d="M1 17h1v1H1zm1 0h1v1H2z"/>
      <path d="M3 17h1v1H3zm1 0h1v1H4zm1 0h1v1H5zm1 0h1v1H6zm1 0h1v1H7zm1 0h1v1H8zm1 0h1v1H9z"/>
      <path fill="#c04040" d="M10 17h1v1h-1z"/>
      <path d="M11 17h1v1h-1zM1 18h1v1H1z"/>
      <path fill="#7f4040" d="M2 18h1v1H2zm1 0h1v1H3z"/>
      <path d="M4 18h1v1H4zm1 0h1v1H5zm1 0h1v1H6zm1 0h1v1H7zm1 0h1v1H8z"/>
      <path fill="#bf985f" d="M9 18h1v1H9z"/>
      <path fill="#c04040" d="M10 18h1v1h-1z"/>
      <path d="M11 18h1v1h-1zm-9 1h1v1H2zm1 0h1v1H3zm4 0h1v1H7z"/>
      <path fill="#ff605f" d="M8 19h1v1H8zm1 0h1v1H9z"/>
      <path d="M10 19h1v1h-1zm-2 1h1v1H8zm1 0h1v1H9z"/>
    </>
  );
}
