...
export default function SpriteRightStanding() {
  return (
    <>
      ...
      <path fill="#10203f" d="M8 13h1v1H8z"/>
      ...
      <path fill="#10203f" d="M6 14h1v1H6z"/>
      <path d="M7 14h1v1H7zm1 0h1v1H8z"/>
      <path fill="#10203f" d="M9 14h1v1H9z"/>
      <path fill="#c04040" d="M10 14h1v1h-1z"/>
      <path fill="#7f4040" d="M11 14h1v1h-1z"/>
      <path d="M2 15h1v1H2z"/>
      <path fill="#bf985f" d="M3 15h1v1H3zm1 0h1v1H4z"/>
      <path fill="#10203f" d="M5 15h1v1H5z"/>
      <path d="M6 15h1v1H6z"/>
      <path fill="#ffc05f" d="M7 15h1v1H7zm1 0h1v1H8z"/>
      <path d="M9 15h1v1H9z"/>
      <path fill="#10203f" d="M10 15h1v1h-1z"/>
      <path fill="#7f4040" d="M11 15h1v1h-1z"/>
      <path d="M3 16h1v1H3z"/>
      <path fill="#bf985f" d="M4 16h1v1H4z"/>
      <path d="M5 16h1v1H5zm1 0h1v1H6z"/>
      <path fill="#bf985f" d="M7 16h1v1H7zm1 0h1v1H8z"/>
      <path d="M9 16h1v1H9z"/>
      <path fill="#10203f" d="M10 16h1v1h-1z"/>
      <path d="M11 16h1v1h-1zm-7 1h1v1H4zm1 0h1v1H5zm1 0h1v1H6zm1 0h1v1H7zm1 0h1v1H8zm1 0h1v1H9zm1 0h1v1h-1zm-5 1h1v1H5zm1 0h1v1H6zm1 0h1v1H7zm1 0h1v1H8zm1 0h1v1H9zm1 0h1v1h-1zm-5 1h1v1H5z"/>
      <path fill="#7f4040" d="M6 19h1v1H6z"/>
      <path fill="#bf985f" d="M7 19h1v1H7z"/>
      <path fill="#10203f" d="M8 19h1v1H8zm1 0h1v1H9z"/>
      <path fill="#c04040" d="M10 19h1v1h-1z"/>
      <path d="M11 19h1v1h-1zm-5 1h1v1H6zm1 0h1v1H7zm1 0h1v1H8zm1 0h1v1H9zm1 0h1v1h-1z"/>
    </>
  );
}
