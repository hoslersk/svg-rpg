...
export default function SpriteBackWalkingOne() {
  return (
    <>
      ...
      <path fill="#10203f" d="M3 12h1v1H3z"/>
      <path fill="#c04040" d="M4 12h1v1H4z"/>
      <path fill="#7f4040" d="M5 12h1v1H5zm1 0h1v1H6zm1 0h1v1H7zm1 0h1v1H8z"/>
      <path fill="#10203f" d="M9 12h1v1H9zm1 0h1v1h-1z"/>
      <path fill="#bf985f" d="M11 12h1v1h-1z"/>
      <path d="M12 12h1v1h-1zM2 13h1v1H2z"/>
      <path fill="#c04040" d="M3 13h1v1H3z"/>
      <path fill="#10203f" d="M4 13h1v1H4z"/>
      <path d="M5 13h1v1H5zm1 0h1v1H6zm1 0h1v1H7zm1 0h1v1H8z"/>
      <path fill="#10203f" d="M9 13h1v1H9z"/>
      <path d="M10 13h1v1h-1zm1 0h1v1h-1zm-9 1h1v1H2z"/>
      <path fill="#7f4040" d="M3 14h1v1H3z"/>
      <path d="M4 14h1v1H4z"/>
      <path fill="#bf985f" d="M5 14h1v1H5z"/>
      <path fill="#fff8ff" d="M6 14h1v1H6zm1 0h1v1H7z"/>
      <path fill="#bf985f" d="M8 14h1v1H8z"/>
      <path d="M9 14h1v1H9zm1 0h1v1h-1zm1 0h1v1h-1z"/>
      <path fill="#7f4040" d="M1 15h1v1H1z"/>
      <path fill="#ffc05f" d="M2 15h1v1H2z"/>
      <path d="M3 15h1v1H3z"/>
      ...
      <path fill="#10203f" d="M1 16h1v1H1z"/>
      <path fill="#bf985f" d="M2 16h1v1H2z"/>
      <path d="M3 16h1v1H3z"/>
      ...
      <path fill="#10203f" d="M2 17h1v1H2z"/>
      <path d="M3 17h1v1H3zm1 0h1v1H4z"/>
      <path fill="#bf985f" d="M5 17h1v1H5zm1 0h1v1H6zm1 0h1v1H7zm1 0h1v1H8z"/>
      <path d="M9 17h1v1H9zm1 0h1v1h-1zm-6 1h1v1H4zm1 0h1v1H5zm1 0h1v1H6zm1 0h1v1H7zm1 0h1v1H8zm1 0h1v1H9zm1 0h1v1h-1zm-4 1h1v1H6z"/>
      <path fill="#7f4040" d="M7 19h1v1H7zm1 0h1v1H8z"/>
      <path fill="#c04040" d="M9 19h1v1H9z"/>
