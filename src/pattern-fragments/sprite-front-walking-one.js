...
export default function SpriteFrontWalkingOne(props) {
  return (
    <>
      ...
      <path fill="#7f4040" d="M11 11h1v1h-1zM0 12h1v1H0z"/>
      <path fill="#bf985f" d="M1 12h1v1H1z"/>
      ...
      <path fill="#10203f" d="M0 13h1v1H0z"/>
      <path fill="#bf985f" d="M1 13h1v1H1z"/>
      ...
      <path fill="#10203f" d="M1 14h1v1H1z"/>
      <path d="M2 14h1v1H2z"/>
      <path fill="#10203f" d="M3 14h1v1H3zm1 0h1v1H4zm1 0h1v1H5z"/>
      <path fill="#c04040" d="M6 14h1v1H6zm1 0h1v1H7z"/>
      <path fill="#10203f" d="M8 14h1v1H8zm1 0h1v1H9z"/>
      <path d="M10 14h1v1h-1zm1 0h1v1h-1z"/>
      ...
      <path d="M9 15h1v1H9z"/>
      <path fill="#ffc05f" d="M10 15h1v1h-1zm1 0h1v1h-1z"/>
      <path d="M12 15h1v1h-1zm-9 1h1v1H3zm1 0h1v1H4z"/>
      <path fill="#7f4040" d="M5 16h1v1H5zm1 0h1v1H6z"/>
      <path fill="#10203f" d="M7 16h1v1H7z"/>
      <path fill="#c04040" d="M8 16h1v1H8z"/>
      <path d="M9 16h1v1H9z"/>
      <path fill="#bf985f" d="M10 16h1v1h-1zm1 0h1v1h-1z"/>
      <path d="M12 16h1v1h-1z"/>
      <path fill="#10203f" d="M3 17h1v1H3z"/>
      <path d="M4 17h1v1H4zm1 0h1v1H5zm1 0h1v1H6zm1 0h1v1H7zm1 0h1v1H8zm1 0h1v1H9zm1 0h1v1h-1zm1 0h1v1h-1zm-8 1h1v1H3z"/>
      <path fill="#7f4040" d="M4 18h1v1H4z"/>
      <path fill="#bf985f" d="M5 18h1v1H5z"/>
      <path fill="#7f4040" d="M6 18h1v1H6z"/>
      <path d="M7 18h1v1H7zm1 0h1v1H8zm1 0h1v1H9zm-6 1h1v1H3z"/>
      <path fill="#7f4040" d="M4 19h1v1H4z"/>
      <path fill="#c04040" d="M5 19h1v1H5z"/>
      <path fill="#7f4040" d="M6 19h1v1H6z"/>
